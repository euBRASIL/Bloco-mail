...
const Index = ({ store }) => {
  ...
  const onUnSpam = async (current, ev = null) => {
    batchAction(menuList, setMenuList, current, bindedNft?.emailName, async (params) => await batchSpam(params, false), getDelList, ev)
  };
    ...
    <Container refs={rootRef}>
      <SearchBar>
        <SearchActions>
          ...
          <div className="chunk">
            <div className="undelete" onClick={() => onUnSpam("multi")}></div>
